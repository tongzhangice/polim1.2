load('./benchmark_solutions/Kleiner_ExpB_analy_solution.mat')

figure
subplot(1,3,1)
hold on
plot(enthB_analy_E/1000, enthB_analy_z, 'r', 'linewidth', 3)
plot(At_E(:,1,end)/1000, zeta, '-k', 'linewidth', 1.5)
...
plot(At_T(:,1,end)-273.15, zeta, '-k', 'linewidth', 1.5)
...
plot(At_omega(:,1,end)*100, zeta, '-k', 'linewidth', 1.5)
